  ...
  return (
    <div className="max-w-md mx-auto p-4 ">
      ...
      <form onSubmit={handleLogin} className="space-y-2">
        ...
        <Button
          className="w-full mt-4 border border-accent dark:border-dark-accent bg-card dark:bg-dark-card hover:bg-card dark:hover:bg-dark-card hover:bg-opacity-80 dark:hover:bg-opacity-80"
